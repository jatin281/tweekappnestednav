...
@Composable
fun SessionSummaryCard( onClick : () -> Unit){
    ...
    Card(
        ...
        Row(
            ...
            Image(
                painter = painterResource(id = R.drawable.session_card_img),
                contentScale = ContentScale.Fit,
                contentDescription = null
            )

            Text(text = "Session Summary", fontSize = 25.sp, color = Color.Black, fontWeight = Bold, textAlign = TextAlign.Start)
