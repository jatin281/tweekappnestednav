...
@Composable
fun SessionHistoryCard(img: Int, text: String, onClick : () -> Unit){
    ...
    ConstraintLayout(constraints, modifier = Modifier
        ...
        .clickable(onClick = onClick)
            ...
            verticalArrangement = Arrangement.Center) {
                ...
                Text(text = "Session 4", fontSize = 15.sp, color = Color.Black)

                Text(text = text, fontSize = 10.sp, color = Color.LightGray)
            ...
            Column(
                ...
                Text(text = "27 Apr 2022", fontSize = 15.sp, color = Color.Black)

                Text(text = "3:30 pm", fontSize = 10.sp, color = Color.LightGray)
